...
class Seq2Seq_Detectron:
    ...
    def __init__(self, input):
        ...
        self.model = VisionEncoderDecoderModel.from_pretrained("tuned-trocr")
        pass
    ...
    def register_dataset(name, dirname):
        df = Seq2Seq_Detectron.load_list_from_file('bounding-box.txt')
    ...
    def predict_trocr(self):
        ...
        for file in os.listdir('bounding_box_images'):
            image, pixel_values = Seq2Seq_Detectron.retrieve_sample(file)
